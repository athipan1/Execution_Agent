...
def is_stale_order(
    ...
    *,
    ...
    max_age = int(
        ...
        else settings.MAX_STALE_OPEN_ORDER_AGE_MINUTES
...
def classify_open_orders(
    ...
    *,
    ...
    for order in open_orders or []:
        ...
        enriched = {
            ...
            **order,
            ...
            "protective_exit_order": is_protective_exit_order(
    ...
    return {
        ...
        "max_stale_open_order_age_minutes": int(
...
class BrokerCleanupService:
    ...
    async def cleanup_status(
        ...
        classified = classify_open_orders(
        ...
        return {
            ...
            **classified,
            ...
            "cleanup_required": (
                ...
                classified["stale_order_count"] > 0

                or str(account.get("buying_power", "0")) in {"0", "0.0", "0.00"}
    ...
    async def cancel_stale_open_orders(
        ...
        *,
        ...
        return {
            ...
            "max_stale_open_order_age_minutes": classified[

                "max_stale_open_order_age_minutes"
